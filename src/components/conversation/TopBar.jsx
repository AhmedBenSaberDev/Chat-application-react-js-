    ...
    return(
        <Col className={`${classes.wrapper} d-flex justify-content-between align-items-center`}>
            ...
            {props.user && <div className="d-flex justify-content-between align-items-center">
                <Image roundedCircle style={{width:"40px",height:"40px",objectFit:"cover"}}  src={props.user.image ? env.END_POINT +  props.user.image : "https://icon-library.com/images/anonymous-avatar-icon/anonymous-avatar-icon-25.jpg" }></Image>
